...
public:
	...
	UFUNCTION(BlueprintCallable, BlueprintNativeEvent, Category = "BPI Human Character AI|Action")
	...
	//Blueprint Interface - Human Character AI (Implemented for Human Character Class)
	UFUNCTION(BlueprintCallable, BlueprintNativeEvent, Category = "BPI Human Character AI|Set")
	...
	//Blueprint Interface - Human Character AI (Implemented for Human Character Class)
	UFUNCTION(BlueprintCallable, BlueprintNativeEvent, Category = "BPI Human Character AI|Get")
	...
	UFUNCTION(BlueprintCallable, BlueprintNativeEvent, Category = "BPI Human Character AI|Get", meta = (AdvancedDisplay = 2))
	...
	UFUNCTION(BlueprintCallable, BlueprintNativeEvent, Category = "BPI Human Character AI|Get", meta = (AdvancedDisplay = 1))
	...
	UFUNCTION(BlueprintCallable, BlueprintNativeEvent, Category = "BPI Human Character AI|Set", meta = (ForceAsFunction, AdvancedDisplay = 1))
