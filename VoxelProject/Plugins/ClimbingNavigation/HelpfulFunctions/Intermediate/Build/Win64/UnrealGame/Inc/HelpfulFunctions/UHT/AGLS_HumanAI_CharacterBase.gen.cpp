...
static FName NAME_AAGLS_HumanAI_CharacterBase_ApplyDamageValue = FName(TEXT("ApplyDamageValue"));
bool AAGLS_HumanAI_CharacterBase::ApplyDamageValue(AActor* DamageCauser, FHitResult HitInfo, float DamageValue, int32 DamageTypeIndex, float UnRagdollTime)
{
	...
	ProcessEvent(FindFunctionChecked(NAME_AAGLS_HumanAI_CharacterBase_ApplyDamageValue),&Parms);
...
static FName NAME_AAGLS_HumanAI_CharacterBase_AttachPropTo = FName(TEXT("AttachPropTo"));
void AAGLS_HumanAI_CharacterBase::AttachPropTo(CALS_OverlayState TargetOverlay, float DelayTime)
{
	...
	ProcessEvent(FindFunctionChecked(NAME_AAGLS_HumanAI_CharacterBase_AttachPropTo),&Parms);
}
...
static FName NAME_AAGLS_HumanAI_CharacterBase_CanUpdateOverlay = FName(TEXT("CanUpdateOverlay"));
bool AAGLS_HumanAI_CharacterBase::CanUpdateOverlay(CALS_OverlayState NewOverlay, CALS_OverlayState CurrentOverlay, bool forced)
{
	...
	ProcessEvent(FindFunctionChecked(NAME_AAGLS_HumanAI_CharacterBase_CanUpdateOverlay),&Parms);
	return !!Parms.ReturnValue;
}
...
static FName NAME_AAGLS_HumanAI_CharacterBase_CheckFallDamage = FName(TEXT("CheckFallDamage"));
bool AAGLS_HumanAI_CharacterBase::CheckFallDamage(FHitResult LandHitResult, float VelocityMaxRange, FVector DamageTresholds)
{
	...
	ProcessEvent(FindFunctionChecked(NAME_AAGLS_HumanAI_CharacterBase_CheckFallDamage),&Parms);
	return !!Parms.ReturnValue;
}
...
static FName NAME_AAGLS_HumanAI_CharacterBase_CheckHealthPerFrame = FName(TEXT("CheckHealthPerFrame"));
void AAGLS_HumanAI_CharacterBase::CheckHealthPerFrame(bool Update)
{
	...
	ProcessEvent(FindFunctionChecked(NAME_AAGLS_HumanAI_CharacterBase_CheckHealthPerFrame),&Parms);
}
...
static FName NAME_AAGLS_HumanAI_CharacterBase_DeathByFallDamage = FName(TEXT("DeathByFallDamage"));
void AAGLS_HumanAI_CharacterBase::DeathByFallDamage(FHitResult HitGroundResult)
{
	...
	ProcessEvent(FindFunctionChecked(NAME_AAGLS_HumanAI_CharacterBase_DeathByFallDamage),&Parms);
}
...
static FName NAME_AAGLS_HumanAI_CharacterBase_DropProps = FName(TEXT("DropProps"));
void AAGLS_HumanAI_CharacterBase::DropProps(TArray<CALS_OverlayState> const& PropsList, bool DropGunsAttachedToBody)
{
	...
	ProcessEvent(FindFunctionChecked(NAME_AAGLS_HumanAI_CharacterBase_DropProps),&Parms);
}
...
static FName NAME_AAGLS_HumanAI_CharacterBase_GetGetUpAnimation = FName(TEXT("GetGetUpAnimation"));
TSoftObjectPtr<UAnimMontage> AAGLS_HumanAI_CharacterBase::GetGetUpAnimation()
{
	...
	ProcessEvent(FindFunctionChecked(NAME_AAGLS_HumanAI_CharacterBase_GetGetUpAnimation),&Parms);
	return Parms.ReturnValue;
}
...
static FName NAME_AAGLS_HumanAI_CharacterBase_GetPistolAmmoData = FName(TEXT("GetPistolAmmoData"));
bool AAGLS_HumanAI_CharacterBase::GetPistolAmmoData(int32& CurrentAmmoCount, int32& CurrentMagazinesCount, int32& MaxAmmoCount, int32& MaxMagazinesCount)
{
	...
	ProcessEvent(FindFunctionChecked(NAME_AAGLS_HumanAI_CharacterBase_GetPistolAmmoData),&Parms);
...
static FName NAME_AAGLS_HumanAI_CharacterBase_GetRifleAmmoData = FName(TEXT("GetRifleAmmoData"));
bool AAGLS_HumanAI_CharacterBase::GetRifleAmmoData(int32& CurrentAmmoCount, int32& CurrentMagazinesCount, int32& MaxAmmoCount, int32& MaxMagazinesCount)
{
	...
	Parms.MaxAmmoCount=MaxAmmoCount;
	Parms.MaxMagazinesCount=MaxMagazinesCount;
	ProcessEvent(FindFunctionChecked(NAME_AAGLS_HumanAI_CharacterBase_GetRifleAmmoData),&Parms);
	CurrentAmmoCount=Parms.CurrentAmmoCount;
	CurrentMagazinesCount=Parms.CurrentMagazinesCount;
	MaxAmmoCount=Parms.MaxAmmoCount;
	MaxMagazinesCount=Parms.MaxMagazinesCount;
...
static FName NAME_AAGLS_HumanAI_CharacterBase_OnMovementActionChanged = FName(TEXT("OnMovementActionChanged"));
void AAGLS_HumanAI_CharacterBase::OnMovementActionChanged(CALS_MovementAction NewMovementAction)
{
	...
	ProcessEvent(FindFunctionChecked(NAME_AAGLS_HumanAI_CharacterBase_OnMovementActionChanged),&Parms);
}
...
static FName NAME_AAGLS_HumanAI_CharacterBase_OnMovementStateChanged = FName(TEXT("OnMovementStateChanged"));
void AAGLS_HumanAI_CharacterBase::OnMovementStateChanged(CALS_MovementState NewMovementState)
{
	...
	ProcessEvent(FindFunctionChecked(NAME_AAGLS_HumanAI_CharacterBase_OnMovementStateChanged),&Parms);
}
...
static FName NAME_AAGLS_HumanAI_CharacterBase_OnOverlayStateChanged = FName(TEXT("OnOverlayStateChanged"));
void AAGLS_HumanAI_CharacterBase::OnOverlayStateChanged(CALS_OverlayState NewOverlayState)
{
	...
	ProcessEvent(FindFunctionChecked(NAME_AAGLS_HumanAI_CharacterBase_OnOverlayStateChanged),&Parms);
}
...
static FName NAME_AAGLS_HumanAI_CharacterBase_OnRotationModeChanged = FName(TEXT("OnRotationModeChanged"));
void AAGLS_HumanAI_CharacterBase::OnRotationModeChanged(CALS_RotationMode NewRotationMode, float LockTime)
{
	...
	ProcessEvent(FindFunctionChecked(NAME_AAGLS_HumanAI_CharacterBase_OnRotationModeChanged),&Parms);
}
...
static FName NAME_AAGLS_HumanAI_CharacterBase_RagdollEnd = FName(TEXT("RagdollEnd"));
void AAGLS_HumanAI_CharacterBase::RagdollEnd()
{
	ProcessEvent(FindFunctionChecked(NAME_AAGLS_HumanAI_CharacterBase_RagdollEnd),NULL);
}
...
static FName NAME_AAGLS_HumanAI_CharacterBase_RagdollStart = FName(TEXT("RagdollStart"));
void AAGLS_HumanAI_CharacterBase::RagdollStart()
{
	ProcessEvent(FindFunctionChecked(NAME_AAGLS_HumanAI_CharacterBase_RagdollStart),NULL);
}
...
static FName NAME_AAGLS_HumanAI_CharacterBase_SetCurrentMovementParametersValues = FName(TEXT("SetCurrentMovementParametersValues"));
void AAGLS_HumanAI_CharacterBase::SetCurrentMovementParametersValues(bool UseVectorControl)
{
	...
	ProcessEvent(FindFunctionChecked(NAME_AAGLS_HumanAI_CharacterBase_SetCurrentMovementParametersValues),&Parms);
}
...
static FName NAME_AAGLS_HumanAI_CharacterBase_StartDyingSequence = FName(TEXT("StartDyingSequence"));
bool AAGLS_HumanAI_CharacterBase::StartDyingSequence(FVector ImpulseNormal, FVector ImpulseLocation, CALS_DeathType DeathType, FName HitBoneName, int32 RifleModelIndex)
{
	...
	ProcessEvent(FindFunctionChecked(NAME_AAGLS_HumanAI_CharacterBase_StartDyingSequence),&Parms);
	return !!Parms.ReturnValue;
}
...
static FName NAME_AAGLS_HumanAI_CharacterBase_TrySimpleTraversalAction = FName(TEXT("TrySimpleTraversalAction"));
bool AAGLS_HumanAI_CharacterBase::TrySimpleTraversalAction()
{
	...
	ProcessEvent(FindFunctionChecked(NAME_AAGLS_HumanAI_CharacterBase_TrySimpleTraversalAction),&Parms);
	return !!Parms.ReturnValue;
}
...
static FName NAME_AAGLS_HumanAI_CharacterBase_UpdateGroundedMovementValues = FName(TEXT("UpdateGroundedMovementValues"));
void AAGLS_HumanAI_CharacterBase::UpdateGroundedMovementValues(bool UseVectorControl)
{
	...
	Parms.UseVectorControl=UseVectorControl ? true : false;
	ProcessEvent(FindFunctionChecked(NAME_AAGLS_HumanAI_CharacterBase_UpdateGroundedMovementValues),&Parms);
}
...
const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_AAGLS_HumanAI_CharacterBase_Statics::InterfaceParams[] = {
	{ Z_Construct_UClass_UAGLS_AI_HumanCharInterface_NoRegister, (int32)VTABLE_OFFSET(AAGLS_HumanAI_CharacterBase, IAGLS_AI_HumanCharInterface), false },  // 3641697735
};
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_UE___Projects_UE5_4_AGLS_v1_0__Experimental__Plugins_HelpfulFunctions_Source_HelpfulFunctions_Public_AGLS_HumanAI_CharacterBase_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AAGLS_HumanAI_CharacterBase, AAGLS_HumanAI_CharacterBase::StaticClass, TEXT("AAGLS_HumanAI_CharacterBase"), &Z_Registration_Info_UClass_AAGLS_HumanAI_CharacterBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AAGLS_HumanAI_CharacterBase), 1769928944U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UE___Projects_UE5_4_AGLS_v1_0__Experimental__Plugins_HelpfulFunctions_Source_HelpfulFunctions_Public_AGLS_HumanAI_CharacterBase_h_1460222581(TEXT("/Script/HelpfulFunctions"),
	Z_CompiledInDeferFile_FID_UE___Projects_UE5_4_AGLS_v1_0__Experimental__Plugins_HelpfulFunctions_Source_HelpfulFunctions_Public_AGLS_HumanAI_CharacterBase_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UE___Projects_UE5_4_AGLS_v1_0__Experimental__Plugins_HelpfulFunctions_Source_HelpfulFunctions_Public_AGLS_HumanAI_CharacterBase_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
