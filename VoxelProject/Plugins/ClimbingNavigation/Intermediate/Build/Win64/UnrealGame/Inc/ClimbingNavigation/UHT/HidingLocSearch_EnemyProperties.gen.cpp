...
static FName NAME_UHidingLocSearch_EnemyProperties_GetCurrentEnemySightParams = FName(TEXT("GetCurrentEnemySightParams"));
void UHidingLocSearch_EnemyProperties::GetCurrentEnemySightParams(float& HalfAngle, float& SightRadius, float& SightHeight, ACharacter* CurrentEnemy, ACharacter* Searcher)
{
	...
	ProcessEvent(FindFunctionChecked(NAME_UHidingLocSearch_EnemyProperties_GetCurrentEnemySightParams),&Parms);
...
static FName NAME_UHidingLocSearch_EnemyProperties_GetPredictedEnemyTransform = FName(TEXT("GetPredictedEnemyTransform"));
void UHidingLocSearch_EnemyProperties::GetPredictedEnemyTransform(FVector& ReturnLocation, FRotator& ReturnRotation, ACharacter* CurrentEnemy, ACharacter* Searcher, int32 IterationIndex)
{
	...
	ProcessEvent(FindFunctionChecked(NAME_UHidingLocSearch_EnemyProperties_GetPredictedEnemyTransform),&Parms);
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_UE___Projects_UE5_4_AGLS_v1_0__Experimental__Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_HidingLocSearch_EnemyProperties_h_Statics
{
...
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UE___Projects_UE5_4_AGLS_v1_0__Experimental__Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_HidingLocSearch_EnemyProperties_h_78457336(TEXT("/Script/ClimbingNavigation"),
	Z_CompiledInDeferFile_FID_UE___Projects_UE5_4_AGLS_v1_0__Experimental__Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_HidingLocSearch_EnemyProperties_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UE___Projects_UE5_4_AGLS_v1_0__Experimental__Plugins_ClimbingNavigation_Source_ClimbingNavigation_Public_HidingLocSearch_EnemyProperties_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
