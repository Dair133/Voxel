...
static FName NAME_UAGLS_AI_AnimInstanceBase_GenerateTrajectory = FName(TEXT("GenerateTrajectory"));
FPoseSearchQueryTrajectory UAGLS_AI_AnimInstanceBase::GenerateTrajectory(int32 HistoryCount, float InPredictionInterval, int32 PreditionCount)
{
	...
	ProcessEvent(FindFunctionChecked(NAME_UAGLS_AI_AnimInstanceBase_GenerateTrajectory),&Parms);
...
static FName NAME_UAGLS_AI_AnimInstanceBase_GetOffsetRootLocationMode = FName(TEXT("GetOffsetRootLocationMode"));
int32 UAGLS_AI_AnimInstanceBase::GetOffsetRootLocationMode()
{
	...
	ProcessEvent(FindFunctionChecked(NAME_UAGLS_AI_AnimInstanceBase_GetOffsetRootLocationMode),&Parms);
	return Parms.ReturnValue;
}
...
static FName NAME_UAGLS_AI_AnimInstanceBase_GetOffsetRootRotationMode = FName(TEXT("GetOffsetRootRotationMode"));
int32 UAGLS_AI_AnimInstanceBase::GetOffsetRootRotationMode()
{
	...
	ProcessEvent(FindFunctionChecked(NAME_UAGLS_AI_AnimInstanceBase_GetOffsetRootRotationMode),&Parms);
	return Parms.ReturnValue;
}
...
static FName NAME_UAGLS_AI_AnimInstanceBase_SetRootTransform = FName(TEXT("SetRootTransform"));
void UAGLS_AI_AnimInstanceBase::SetRootTransform()
{
	ProcessEvent(FindFunctionChecked(NAME_UAGLS_AI_AnimInstanceBase_SetRootTransform),NULL);
}
...
static FName NAME_UAGLS_AI_AnimInstanceBase_ShouldTurnInPlace = FName(TEXT("ShouldTurnInPlace"));
bool UAGLS_AI_AnimInstanceBase::ShouldTurnInPlace()
{
	AGLS_AI_AnimInstanceBase_eventShouldTurnInPlace_Parms Parms;
	ProcessEvent(FindFunctionChecked(NAME_UAGLS_AI_AnimInstanceBase_ShouldTurnInPlace),&Parms);
	return !!Parms.ReturnValue;
}
...
static FName NAME_UAGLS_AI_AnimInstanceBase_UpdateCoverValues = FName(TEXT("UpdateCoverValues"));
void UAGLS_AI_AnimInstanceBase::UpdateCoverValues()
{
	ProcessEvent(FindFunctionChecked(NAME_UAGLS_AI_AnimInstanceBase_UpdateCoverValues),NULL);
}
...
static FName NAME_UAGLS_AI_AnimInstanceBase_UpdateFootsIK = FName(TEXT("UpdateFootsIK"));
void UAGLS_AI_AnimInstanceBase::UpdateFootsIK(ECollisionChannel TraceChannel, bool UseFootsLock, float TraceAboveFoot, float TraceBelowFoot, float FootHeight, int32 ActiveOnLOD, int32 TraceDebugIndex, float DebugTime)
{
	...
	ProcessEvent(FindFunctionChecked(NAME_UAGLS_AI_AnimInstanceBase_UpdateFootsIK),&Parms);
}
...
static FName NAME_UAGLS_AI_AnimInstanceBase_UpdateRotationValues = FName(TEXT("UpdateRotationValues"));
void UAGLS_AI_AnimInstanceBase::UpdateRotationValues()
{
	ProcessEvent(FindFunctionChecked(NAME_UAGLS_AI_AnimInstanceBase_UpdateRotationValues),NULL);
}
...
struct Z_Construct_UClass_UAGLS_AI_AnimInstanceBase_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UAGLS_AI_AnimInstanceBase_GenerateTrajectory, "GenerateTrajectory" }, // 3674685658
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_UE___Projects_UE5_4_AGLS_v1_0__Experimental__Plugins_HelpfulFunctions_Source_HelpfulFunctions_Public_AGLS_AI_AnimInstanceBase_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UAGLS_AI_AnimInstanceBase, UAGLS_AI_AnimInstanceBase::StaticClass, TEXT("UAGLS_AI_AnimInstanceBase"), &Z_Registration_Info_UClass_UAGLS_AI_AnimInstanceBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAGLS_AI_AnimInstanceBase), 602545981U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UE___Projects_UE5_4_AGLS_v1_0__Experimental__Plugins_HelpfulFunctions_Source_HelpfulFunctions_Public_AGLS_AI_AnimInstanceBase_h_685722194(TEXT("/Script/HelpfulFunctions"),
	Z_CompiledInDeferFile_FID_UE___Projects_UE5_4_AGLS_v1_0__Experimental__Plugins_HelpfulFunctions_Source_HelpfulFunctions_Public_AGLS_AI_AnimInstanceBase_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UE___Projects_UE5_4_AGLS_v1_0__Experimental__Plugins_HelpfulFunctions_Source_HelpfulFunctions_Public_AGLS_AI_AnimInstanceBase_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
