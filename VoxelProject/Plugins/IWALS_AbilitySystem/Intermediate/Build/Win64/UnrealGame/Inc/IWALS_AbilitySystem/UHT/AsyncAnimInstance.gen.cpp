...
static FName NAME_UAsyncAnimInstance_CustomTick = FName(TEXT("CustomTick"));
void UAsyncAnimInstance::CustomTick(float DeltaSecond)
{
	AsyncAnimInstance_eventCustomTick_Parms Parms;
	Parms.DeltaSecond=DeltaSecond;
	ProcessEvent(FindFunctionChecked(NAME_UAsyncAnimInstance_CustomTick),&Parms);
}
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_UE___Projects_UE5_4_AGLS_v1_0__Experimental__Plugins_IWALS_AbilitySystem_Source_IWALS_AbilitySystem_Public_AsyncAnimInstance_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UAsyncAnimInstance, UAsyncAnimInstance::StaticClass, TEXT("UAsyncAnimInstance"), &Z_Registration_Info_UClass_UAsyncAnimInstance, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAsyncAnimInstance), 3544908819U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UE___Projects_UE5_4_AGLS_v1_0__Experimental__Plugins_IWALS_AbilitySystem_Source_IWALS_AbilitySystem_Public_AsyncAnimInstance_h_2894293369(TEXT("/Script/IWALS_AbilitySystem"),
	Z_CompiledInDeferFile_FID_UE___Projects_UE5_4_AGLS_v1_0__Experimental__Plugins_IWALS_AbilitySystem_Source_IWALS_AbilitySystem_Public_AsyncAnimInstance_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UE___Projects_UE5_4_AGLS_v1_0__Experimental__Plugins_IWALS_AbilitySystem_Source_IWALS_AbilitySystem_Public_AsyncAnimInstance_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
